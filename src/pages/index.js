...
export { TouristKz } from './tourist/TouristKz'
...
export { Moderation } from './market/moderation'
export { AllShops } from './market/all-shops'
export { Chat } from './market/chat'
export { Orders } from './market/orders'
export { Products } from './market/products'
export { Rare } from './market/rare'
export { Discounts } from './market/discounts'
export { MarketCarousel } from './market/carousel'
export { Weare } from './market/weare'
export { Reviews } from './market/reviews'